...
<%
	...
	/*
		- 세선에 저장된 데이터는 브라우저 창이 종료될 떄까지 혹은 세션의 유효시간이 만료되기 전까지 웹 어플리케이션의 모든 jsp페이지에서 사용할 수 있습니다.
		- 세션에 저장된 데이터를 가져오려면 session객체의
		getAttribute()메서드를 사용하여 메개값으로 가져올 데이터의 세션 이름을 적습니다.
	*/
	...
	//isRequestedSessionInValid() = 유효한 세션 데이터가 존재하는지를 확인하는 메서드
